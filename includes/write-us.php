...
if($lastInsertId)
{
$_SESSION['msg']=" اطلاعات شما با موفقیت ارسال شد ";
						...
						<div class="modal-header">
							...
							<form name="help" method="post">
								<div class="modal-body modal-spa">
									<div class="writ">
										<h4> چگونه می‌توانیم به شما کمک کنیم؟ </h4>
											<ul>
												
												<li class="na-me">
													<select id="country" name="issue" class="frm-field required sect" required="">
														<option value=""> موضوع مورد نظر خودتان را انتخاب کنید </option> 		
														<option value="مسائل مربوط به رزرو">مسائل مربوط به رزرو</option>
														<option value="لغو">لغو</option>
														<option value="باز پرداخت">باز پرداخت</option>
														<option value="سایر موارد">سایر موارد</option>														
													</select>
												</li>
											
												<li class="descrip">
									<input class="special" type="text" placeholder="توضیح"  name="description" required="">
												</li>
													<div class="clearfix"></div>
											</ul>
											<div class="sub-bn">
												<form>
													<button type="submit" name="submit" class="subbtn"> ارسال </button>
												</form>
											</div>
									</div>
								</div>
