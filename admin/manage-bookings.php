...
$query -> execute();
$msg="رزرو شما با موفقیت تایید شد";
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"> صفحه اصلی </a><i class="fa fa-angle-left"></i> مدیریت رزرو ها </li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->fdate);?> تا <?php echo htmlentities($result->tdate);?></td>
...
{
echo "لغو شده توسط شما در  " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='u')
{
echo "لغو شده توسط کاربر در  " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>لغو شد</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('آیا می‌خواهید رزرو را لغو کنید؟ ')" > لغو </a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('رزرو شما با موفقیت تایید شد ')" > تایید </a></td>
<?php }?>
