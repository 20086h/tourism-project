...
$msg="تیکت به وضعیت خوانده شده تغییر یافت ";
}
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php"> صفحه اصلی </a><i class="fa fa-angle-left"></i> تیکت های پشتیبانی </li>
            </ol>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');"> مشاهده کردن  </a>
</td>
