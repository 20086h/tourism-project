...
{
$error=" قبل از 24 ساعت نمی‌توانید بسته ایجاد شده را حذف کنید ";
}
}
}
}
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;"> تاریخچه رزرو‌های من </h3>
...
{
echo " لغو شده توسط مدیر در  " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td> لغو شد </td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('آیا می‌خواهید رزرو خود را لغو کنید؟')" > لغو کردن </a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
